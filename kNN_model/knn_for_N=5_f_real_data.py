...
cd_dataset = pd.read_table('./AGP_otu_ibd.txt', header = 0, index_col=0, sep = '\t')
hc_dataset = pd.read_table('./AGP_otu_hc.txt', header = 0, index_col=0, sep = '\t')
...
results.to_csv('AGP_knn_%s.txt' % str(n_neighbors), sep='\t')
